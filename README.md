...
* Arduino Due and Arduino Galileo
    * If you are using the Arduino Due or Galileo, then you must include the Arduino SPI library like so: ```#include <SPI.h>``` in your .ino file.
